...
- **Contextily**: Para incorporar mapas de fundo em suas visualizações, confira [contextily.org](https://contextily.readthedocs.io/en/latest/).
- **Geopandas**: Para análise e manipulação de dados geoespaciais, instale o pacote Geopandas. Mais informações estão disponíveis em [geopandas.org](https://geopandas.org/).
